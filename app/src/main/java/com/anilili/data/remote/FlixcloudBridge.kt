...
object FlixcloudBridge {
    ...
    fun attach(wv: WebView) {
        ...
        webView = wv
        com.anilili.diagnostics.ResolverDiagnostics.viewChanged("flixcloud", true)
        ...
        wv.webViewClient = object : WebViewClient() {
            ...
            override fun onRenderProcessGone(view: WebView?, detail: RenderProcessGoneDetail?): Boolean {
                ...
                com.anilili.diagnostics.ResolverDiagnostics.rendererGone("flixcloud", detail?.didCrash())
                complete(activeId, null, "render_gone")
                if (webView === view) {
                    webView = null
                    com.anilili.diagnostics.ResolverDiagnostics.viewChanged("flixcloud", false)
                }
                return true
            }
        }
